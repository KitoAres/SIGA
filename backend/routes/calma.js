...
// Solo activa Modo avión para el usuario que lo pide
router.post('/activar', async (req, res) => {
  ...
  try {
    ...
    // Evita que el admin active Modo avión.
    ...
    // Solo puede haber un Modo avión activo a la vez.
    await pool.query(
      `UPDATE modo_calma
       SET activo = false
       WHERE activo = true`
...
// Solo quien activó el Modo avión puede desactivarlo
