...
(function () {
  const saludosEntrada = [
    ...
    'Sigy extraño muuuuchooo verte por aqui',
    'Sigy lo vio todo',
    'Sigy sabe donde vives...',
    'Si tenemos liquido en nostros, entonces tendemos a atrernos... Quizas',
  ...
  const mensajitosIdle = [
    ...
    'Puedes acercarte sin perseguir.',
    'Decir "me gustaría verte" también es ser honesto.',
    'No necesitas encontrar las palabras perfectas para proponer un momento juntos.',
    'Si tienes ganas de verla, dilo. Sin disfrazarlo de excusa.',
    'Una puerta abierta no significa que tengas que empujarla.',
    'Puedes ofrecer un encuentro y dejar que la otra persona decida.',
    'Quizás hoy sea un buen día para decir simplemente: "¿quieres hacer algo juntos?"',
    'No conviertas una invitación en una prueba de amor.',
    'Invitar es compartir una posibilidad. No exigir una respuesta.',
    ...
    'No somos directos para decir lo que realmente necesitamos... Es cultural, pero no se si eso sea correcto.',
    ...
    'La derivada es la tasa de cambio, a que velocidad cambian las cosas.',
    'En cierta fase del enamoramiento ves a tu ser amado hasta en la sopa.',
    'Quizas lo que necesitamos es ser mas sinceros con lo que queremos de nostros mismos',
    ...
    'Sigy aprendio a farmear aura... SIGYYYY',
    'SIGy puede ser filtro anti-reclamo, pero con ternura.',
    'No hace falta explicar todo para merecer calma.',
    'Si l@ extrañas, por qué no intentas entrar a ¿Nos vemos? que para eso esta.',
    'Sigy analiza y piensa en como mejorar su relacion.',
    'Extrañar a alguien no significa que tengas que escribirle inmediatamente.',
    'Puedes extrañar a alguien y aun así respetar su espacio.',
    'Extrañar también es recordar que algo fue importante.',
    'No todo "te extraño" necesita convertirse en un mensaje.',
    'A veces el corazón quiere acercarse mientras la realidad pide esperar.',
    'Puedes guardar este sentimiento. No tienes que resolverlo ahora.',
    'Quizás no extrañas solamente a la persona. Quizás extrañas una etapa de tu vida.',
    'Hay recuerdos que duelen porque fueron bonitos.',
    'No necesitas dejar de extrañar para empezar a estar bien.',
    'Extrañar no es una orden.',
    'El cariño puede existir incluso cuando no sabes qué hacer con él.',
    'Si hoy duele, quédate un ratito aquí. No hace falta tomar decisiones todavía.',
    'El amor es una necesidad biologica, pero yo creo que puede ser mas...', 
    'La idealizacion controlada es buena.',
    'Creo que una salida pequeñita podría estar bonita hoy.',
    'No necesitas un plan enorme. Una caminata juntos también cuenta.',
    '¿Cuándo fue la última vez que hicieron algo juntos?',
    'Te propongo algo: invítal@ a salir. Sin discurso. Solo un "¿nos vemos?"',
    'Una misión sencilla: hagan algo que ninguno de los dos haya hecho antes.',
    '¿Y si hoy cambian el "te extraño" por un "¿nos vemos?"?',
    'Tu pareja está a un mensaje de distancia. Bueno... probablemente.',
    'No todo recuerdo empieza con una foto. Algunos empiezan con "¿salimos?"',
    'Pueden quedarse hablando por chat... o crear un recuerdo nuevo.',
    '¿Y si esta semana tienen una cita improvisada?',
    'Una caminata, algo rico y ustedes dos. No parece tan mala idea.',
    'Creo que SIGA necesita un nuevo recuerdo. ¿Qué tal si lo crean juntos?',
    'La misión de hoy podría ser fácil: pasar un ratito juntos.',
    'No hace falta una ocasión especial para tener una cita.',
    'Sigy te desafia a hacer una mision con tu persona favorita.',
    'A tu ritmo. Sin presión. Con cuidadito.',

     //Cuando la otra persona no responde
    'Una ausencia de respuesta también merece ser respetada.',
    'No necesitas mandar cinco mensajes para que uno sea escuchado.',
    'Si ya dijiste lo que sentías, ahora también puedes dejar espacio.',
    'Esperar una respuesta puede doler. Perseguirla probablemente duela más.',
    'No conviertas el silencio en una historia que todavía no conoces.',
    'La ausencia de respuesta tambien es una respuesta (Sigy, 2026 (robado de Watzlawick))',
    'No sabemos qué significa el silencio. Sí sabemos que puedes cuidar cómo respondes a él.',
    'Quizás hoy la misión no sea acercarte. Quizás sea volver un poquito hacia ti.',
    'No responder también comunica algo, aunque no siempre sepamos exactamente qué.',
    'Puedes querer a alguien y decidir no perseguirlo.',
    'Tu valor no disminuye porque alguien no te dé tu lugar.',
    'No necesitas demostrar cuánto te importa escribiendo una y otra vez.',
    'Si ya tocaste la puerta, puedes esperar. No necesitas derribarla.',
    'SIGy recomienda una cosa extraña: dejar el chat quieto un ratito.',
    'No todo silencio necesita ser llenado.',
    'SIGY esta trabajando en una nueva pestaña... Sigy es el Guerrero Chambeador',
    ...
    'Los lugares, olores y texturas traen su recuerdo grabado. ¿Que te parece si revivimos un recuerdo?',
    ...
    'Sigy no ve cambios en SIGA... ¿Todo bien?',
    ...
    'Deja el miedo de lado y solo hazlo.',
    ...
    '¿Extrañas a tu pareja o extrañas como se sentia estar juntos?',
    ...
    'SIGy recomienda planes con baja presión y alto abracito.',
     ...
     //Frases para recuerdos.
    'Guarda esto. Quizás algún día quieras volver a sentir este momento.',
    'Los recuerdos no necesitan ser importantes para todo el mundo. Basta con que sean importantes para ustedes.',
    'Una foto guarda una imagen. Un recuerdo guarda una historia.',
    'No todo recuerdo necesita una explicación.',
    'Algún día quizá mires esto y sonrías.',
    'Este momento está pasando. Si quieres, podemos guardarlo.',
    'Los días normales también merecen ser recordados.',
    'Quizás dentro de un año esto sea una de esas cosas que digan: "¿te acuerdas?"',
    'Hay recuerdos que se vuelven especiales mucho después.',
    'No sabemos qué momentos terminarán siendo importantes. Por eso algunos vale la pena guardarlos.',
    'Un día cualquiera puede convertirse en un recuerdo enorme.',
    'Guarda los pequeños detalles. Son los que más fácil se olvidan.',

     //frases para cuando vuelves
    'Volviste...',
    'Qué raro volver a un lugar lleno de versiones antiguas de nosotros.',
    'Quizás hoy los recuerdos se sienten diferentes.',
    'No eres la misma persona que creó estos recuerdos. Y eso está bien.',
    'Puedes mirar atrás sin volver atrás.',
    '¿Te acuerdas de cómo pensabas cuando guardaste esto?',
    'Hay recuerdos que envejecen contigo.',
    'Quizás esta vez no viniste a extrañar. Quizás viniste a agradecer.',
    'El tiempo cambia muchas cosas. A veces incluso cambia la forma en que recordamos.',
    'Qué bonito que algo que pasó hace tiempo todavía pueda provocar una sonrisa.',
    'Quizás este recuerdo ya no duele. Quizás eso también merece celebrarse.',

    //Parejas felices 

    '¿Todo bien entre ustedes? Perfecto. Ahora vayan a hacer algo bonito.',
    'No esperen a tener un problema para cuidar la relación.',
    'Una relación también se mantiene con momentos aburridos, pequeños y cotidianos.',
    '¿Qué tal si hoy haces algo bonito sin esperar que te lo pidan?',
    'La misión de hoy: sorprender a tu pareja con algo pequeñito.',
    'Pregúntale cómo estuvo realmente su día.',
    'Abraza un poquito más de lo habitual. Solo porque sí.',
    'Hoy toca decir "gracias por estar".',
    'Son novios?? A ver besense. jijiji',
    '¿Qué cosa pequeña hace tu pareja que nunca quieres dejar de ver?',
    'Una relación también necesita mantenimiento preventivo. Sí, como un servidor.',
    'No esperes una fecha especial para crear un recuerdo.',
    'Tu pareja no debería tener que adivinar todo lo que aprecias de ella.',
    'Una buena relación también se construye cuando no hay nada que arreglar.',
    //SIGY cuando no haces nada pero entras
    'No tienes que hacer nada. Puedes simplemente quedarte un ratito.',
    'Puedes venir aquí aunque no tengas nada que decir.',
    'Quizás hoy solo querías mirar. Está bien.',
    'Hay días donde uno abre los recuerdos sin saber exactamente qué está buscando.',
    'No hace falta crear un recuerdo nuevo cada vez que entras.',
    'Puedes leer, recordar y cerrar SIGA cuando quieras.',
    'Si hoy estás pensando mucho, SIGy se sienta aquí contigo.',
    'No todo lo que sentimos necesita convertirse en una acción.',
    'Quizás solo necesitabas volver a mirar.',
    'Los recuerdos siguen aquí. No te están pidiendo nada.',
    'Si llegaste hasta aquí, tómate un momento.',
    'No voy a preguntarte qué pasó. Puedes estar aquí tranquil@.',
    'Quizás algún día este lugar tenga una historia diferente para ti.',
    
    // Frases raras lindas
    'SIGy te manda flores interdimensionales. Llegan sin costo de envío.',
    'Quizás hoy no necesitan resolver nada. Solo estar juntos.',
